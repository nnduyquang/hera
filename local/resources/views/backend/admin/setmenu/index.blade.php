    ...
    <div class="col-lg-12 ">
        <div class="row">
            ...
            <div class="col-md-4 text-right">
                ...
                <a class="btn btn-success" href="{{ route('setmenu.create') }}"> Tạo Mới Bài Viết</a>
                @endpermission
            </div>
        </div>
    </div>
        ...
        <table class="table table-bordered">
            ...
            @foreach ($posts as $key => $data)
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href="{{ route('setmenu.edit',$data->id) }}">Cập Nhật</a>
                    @endpermission
                    @permission(('post-delete'))
                    {!! Form::open(['method' => 'DELETE','route' => ['setmenu.destroy', $data->id],'style'=>'display:inline']) !!}
