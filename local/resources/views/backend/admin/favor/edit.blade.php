...
@section('container')
    ...
    @endif
    {!! Form::model($data['post'],array('route' => ['favor.update',$data['post']->id],'method'=>'PATCH')) !!}
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-6">
                <div class="wrap-create-edit">
                    <strong class="text-title-left">Tên Ưu Đãi</strong>
        ...
        <div class="col-md-12">
            <div class="wrap-create-edit">
                <strong class="text-title-left">Nội Dung Ưu Đãi</strong>
                <div class="form-group">
            ...
            <div class="col-md-12" style="text-align:  center;">
                <button id="btnDanhMuc" type="submit" class="btn btn-primary">Cập Nhật Ưu Đãi</button>
            </div>
        </div>
    </div>
    {!! Form::close() !!}
